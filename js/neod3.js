  ...
  nodeOutline = new neo.Renderer({
    onGraphChange: function(selection, viz) {
      ...
      showDetails = function (node) {
        ...
        content += '<p class="text-center"><span class="typeName">COUNTRY</span><span class="infoContent">' + node.propertyMap.country+ '</span></p>';
        content += '<hr class="tooltip-hr">';
        content += '<p class="text-center"><span class="typeName">TICKER</span><span class="infoContent">' + node.propertyMap.TICKER+ '</span></p>';
        content += '<hr class="tooltip-hr">';
        content += '<p class="text-center"><span class="typeName">EXCHANGE</span><span class="infoContent">' + node.propertyMap.EXCHANGE+ '</span></p>';
        content += '<hr class="tooltip-hr">';
        content += '<p class="text-center"><span class="typeName">indAx</span><span class="infoContent">' + node.propertyMap.indAx+ '</span></p>';
        content += '<hr class="tooltip-hr">';
        content += '<p class="text-center"><span class="typeName">indgrpAx</span><span class="infoContent">' + node.propertyMap.indgrpAx+ '</span></p>';
        content += '<hr class="tooltip-hr">';
        content += '<p class="text-center"><span class="typeName">secAx</span><span class="infoContent">' + node.propertyMap.secAx+ '</span></p>';
        content += '<hr class="tooltip-hr">';
        content += '<p class="text-center"><span class="typeName">SHARES</span><span class="infoContent">' + node.propertyMap.shares+ '</span></p>';
